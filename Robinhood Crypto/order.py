...
def get_all_open_orders():
    ...
    """
    open_orders = rho.get_all_open_crypto_orders()
...
class Order():
    ...
    def update(self, new_order_info=None):
        if new_order_info == None:
            new_order_info = rho.get_crypto_order_info(self.id)
