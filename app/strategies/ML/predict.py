...
prediction_data = pd.read_csv('app/strategies/ML/data/crypto_prediction_data.csv')
...
try:
    model = load_model(f'app/strategies/ML/models/crypto_price_model_{model_uuid}.h5')
